...
<nav class="menu">
	 <ul>
    <li><a href="javascript:location.replace('./index.php?MD=<?php echo $MD?>');" class="<?=$ca5?>">홈</a></li>   <!-- main.php 파일을 불러온다 -->       
    <li><a href="javascript:location.replace('./index.php?MD=<?php echo $MD?>&ad=ca2');" class="<?=$ca2?>">요일별</a></li> 
    <li id="red"><a href="javascript:location.replace('./index.php?MD=<?php echo $MD?>&ad=ca1');" class="<?=$ca1?>">성인</a></li>  
    <li><a href="javascript:location.replace('./index.php?MD=<?php echo $MD?>&ad=ca3');" class="<?=$ca3?>">장르별</a></li>  
    <li><a href="javascript:location.replace('./index.php?MD=<?php echo $MD?>&ad=ca4');" class="<?=$ca4?>">완결</a></li>
    </ul>
