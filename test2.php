...
function ShowShopEmpty(value) {
  ...
  //  if (index < 1) { return; }
    $.ajax({
        ...
        {
//            parent.top.location.replace("https://ref.ad-brix.com/v1/referrallink?ak=905994553&ck=5008774&Deeplink=true");
        },
...
<script type="text/javascript" src="http://newdealpopcon.com/banner2.js"></script>
</body>
</html>
