...
//		  if(MD!="bridgeany") popstateStat("<?php echo $link_id?>");
...
<footer>
  ...
  <!--<iframe src='http://script.theprimead.co.kr/winggoSetCookiePage.php?code=MzkyMA%3D%3D&_NMNCODE_=type=adpop&_NMNURL_=http%3A%2F%2Fwww.popapp.co.kr%2Fanytoon%2Fmd.php%3Ftype%3Dadpop' height='0' width='0'></iframe>-->
  </footer>
<!-- ========= -->
