...
$(document).ready(function () {
            ...
            type: "GET", 
            async: true,
            data: "pageid=<?php echo $pageid1?>&out=json", 
            ...
            type: "GET", 
            async: true,
            data: "pageid=<?=$weekPageId[date('w')]?>&lang=utf-8&out=json",  //오늘날짜 기준으로 요일 키값을 불러옴
            url: "http://ad.ad4989.co.kr/cgi-bin/pelicanc.dll?impr", 
            cache: false, 
            dataType: "jsonp", 
            jsonp: "jquerycallback", 
...
<div class="wrap"> 
  ...
  <section>
    ...
    <nav class="cont" id="toon_type">
      <ul>
        <li><a href="./md.php?MD=<?php echo $MD?>&ad=ca3">멜로/로맨스</a></li>
        <li><a href="./md.php?MD=<?php echo $MD?>&ad=ca3">액션/느와르</a></li>
        <li><a href="./md.php?MD=<?php echo $MD?>&ad=ca3">코믹/스포츠</a></li>
        <li><a href="./md.php?MD=<?php echo $MD?>&ad=ca3">드라마</a></li>
        <li><a href="./md.php?MD=<?php echo $MD?>&ad=ca3">판타지/옴니버스</a></li>
        <li><a href="./md.php?MD=<?php echo $MD?>&ad=ca3">미스터리/호러</a></li>
      </ul>
    </nav>
  </section>
  <!-- --> 
